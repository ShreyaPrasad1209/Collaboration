...
# In[13]:
	...
	personalized_model = turicreate.item_similarity_recommender.create(user_project_data, user_id = 'UserID', item_id = 'Interested')
...
# In[91]:
	...
	rslt_df.to_csv('output'+str(userid)+'.csv')
